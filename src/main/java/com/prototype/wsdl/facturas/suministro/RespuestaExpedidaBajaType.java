...
@XmlType(name = "RespuestaExpedidaBajaType", namespace = "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaSuministro.xsd", propOrder = {
    "idFactura",
    "estadoRegistro",
    "codigoErrorRegistro",
