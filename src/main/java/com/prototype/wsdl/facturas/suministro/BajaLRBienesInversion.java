...
@XmlRootElement(name = "BajaLRBienesInversion", namespace = "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroLR.xsd")
public class BajaLRBienesInversion
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaBienesInversion", namespace = "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroLR.xsd", required = true)
